...
pub use write::{
    DeviceMode, Dpi, DpiCapabilities, DpiInfo, FeatureEntry, FirmwareEntity, FirmwareEntityInfo,
    ...
    OnboardProfilesInfo, OnboardState, ReprogControlEntry, ScrollReportingTarget, ScrollResolution,
    ScrollWheelMode, WriteError, apply_litra, commands_for_light_settings, dump_features,
    dump_firmware_entities, dump_reprog_controls, encode_litra_command, ensure_haptics_armed_on,
    find_litra, get_backlight, get_dpi, get_dpi_info, get_dpi_info_on, get_onboard_state,
